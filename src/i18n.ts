  ...
  try {
    const langData: Record<string, Record<string, string>> = {
      'zh_CN': {
        ...
        'onboardingTitle': '欢迎使用 Quick Paste',
        'onboardingSubtitle': '让重复输入变得简单',
        'onboardingStep1Title': '右键收藏',
        'onboardingStep1Desc': '在网页上选中文本，右键选择「收藏到 Quick Paste」',
        'onboardingStep2Title': '点击粘贴',
        'onboardingStep2Desc': '打开侧边栏，点击任意卡片即可粘贴到输入框',
        ...
        'contextMenuSave': '📥 收藏到 Quick Paste',
        'contextMenuSaveFull': '📥 收藏到 Quick Paste',
        'pickerPreview': '预览：',
        'adSupportLabel': '支持 Quick Paste → 解锁更多功能',
        'langChinese': '中文',
        'langEnglish': 'English',
        'langJapanese': '日本語',
        'langKorean': '한국어',
      ...
      'en': {
        ...
        'onboardingTitle': 'Welcome to QuickPaste',
        'onboardingSubtitle': 'Make repetitive typing simple',
        'onboardingStep1Title': 'Right-click to save',
        'onboardingStep1Desc': 'Select text on any webpage, right-click and choose "Save to QuickPaste"',
        'onboardingStep2Title': 'Click to paste',
        'onboardingStep2Desc': 'Open the sidebar, click any card to paste it into an input field',
        ...
        'contextMenuSave': '📥 Save to QuickPaste',
        'contextMenuSaveFull': '📥 Save to QuickPaste',
        'pickerPreview': 'Preview:',
        'adSupportLabel': 'Support QuickPaste → Unlock more features',
        'langChinese': '中文',
        'langEnglish': 'English',
        'langJapanese': '日本語',
        'langKorean': '한국어',
      ...
      'ja': {
        ...
        'onboardingTitle': 'QuickPasteへようこそ',
        'onboardingSubtitle': '繰り返し入力をシンプルに',
        'onboardingStep1Title': '右クリックで保存',
        'onboardingStep1Desc': 'Webページのテキストを選択し、右クリックで「QuickPasteに保存」を選択',
        'onboardingStep2Title': 'クリックで貼り付け',
        'onboardingStep2Desc': 'サイドバーを開き、カードをクリックして入力欄に自動貼り付け',
        ...
        'contextMenuSave': '📥 QuickPasteに保存',
        'contextMenuSaveFull': '📥 QuickPasteに保存',
        'pickerPreview': 'プレビュー：',
        'adSupportLabel': 'QuickPasteをサポート → もっと機能解脱',
        'langChinese': '中文',
        'langEnglish': 'English',
        'langJapanese': '日本語',
        'langKorean': '한국어',
      ...
      'ko': {
        ...
        'onboardingTitle': 'QuickPaste에 오신 것을 환영합니다',
        'onboardingSubtitle': '반복적인 입력을 간단하게',
        'onboardingStep1Title': '우클릭으로 저장',
        'onboardingStep1Desc': '웹페이지에서 텍스트를 선택하고 우클릭하여 "QuickPaste에 저장" 선택',
        'onboardingStep2Title': '클릭으로 붙여넣기',
        'onboardingStep2Desc': '사이드바를 열고 카드를 클릭하여 입력란에 자동 붙여넣기',
        ...
        'contextMenuSave': '📥 QuickPaste에 저장',
        'contextMenuSaveFull': '📥 QuickPaste에 저장',
        'pickerPreview': '미리보기：',
        'adSupportLabel': 'QuickPaste 지원 → 더 많은 기능 잠금 해제',
        'langChinese': '中文',
        'langEnglish': 'English',
        'langJapanese': '日本語',
        'langKorean': '한국어',
